...
exports.GET_ME_BY_USERNAME = (username) => 
    `SELECT user_id, username, email FROM users WHERE username = ${username}`; // don't return password
...
exports.INSERT_NEW_USER = (username, email, password) => 
    `INSER INTO users (username, email, password) VALUES (${username}, ${email}, ${password})`;
