...
exports.GET_ME_BY_USERNAME = `SELECT user_id, username, email FROM users WHERE username = ?`; // don't return password
...
exports.INSERT_NEW_USER = `INSER INTO users (username, email, password) VALUES (?, ?, ?)`;
